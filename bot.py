...
welcome_msg = '''<b>Bot-a xoş gəlmisiniz</b>🖐🖐
 <i>DP-lərini almaq üçün mənə birinin instagram istifadəçi adını göndərin</i>
 məss : <b>mehdizade_abdulla</b> '''
...
def help_msg(update, context):
    update.message.reply_text("Kömək etmək üçün heç bir şey yoxdur, bu sadə yol 😂😂")


def contact(update, context):
    keyboard = [[InlineKeyboardButton(
        "Contact", url=f"telegram.me/{mehdizade_abdulla}")], ]
...
def username(update, context):
    ...
    try:
        ...
        caption_msg = f'''📛*Name*📛: {user.full_name} \n😁*Followers*😁: {user.followers} \n🤩*Following*🤩: {user.followees}\
         \n🧐*Account Type*🧐: {acc_type(user.is_private)} \n\nBotdan istifadə etdiyiniz üçün təşəkkür edirik 😀😀'''
        ...
        msg.edit_text("Yenidən cəhd edin İstifadəçi adını düzgün yoxlayın")
